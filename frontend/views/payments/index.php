        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="fullname" value="<?php echo "$firstname $lastname"; ?>" class="form-control1" placeholder="">
                </div>
                <div class="form-group">
                    <label>Địa chỉ</label>
                    <input type="text" name="address" value="<?php echo $address ?>" class="form-control1" placeholder="">
                </div>
                <div class="form-group">
                    <label>SĐT</label>
                    <input type="number" min="0" name="mobile" value="<?php echo $phone ?>" class="form-control1" placeholder="">
                </div>
                <div class="form-group">
                    <label>Email</label>
                    <input type="email" min="0" name="email" value="<?php echo $email ?>" class="form-control1" placeholder="">
                </div>
                <div class="form-group">
                    <label>Ghi chú thêm</label>
                    <textarea name="note" class="form-control1"></textarea>
                </div>
                <div class="form-group">
